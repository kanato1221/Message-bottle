    ...
    var sections: [LegalSection] {
        ...
        case .terms:
            return [
                ...
                LegalSection(title: "禁止事項", body: "他人を傷つける内容、個人情報、連絡先、住所、URL、犯罪や危険行為を助長する内容、不適切な表現を投稿することは禁止します。このアプリは不適切なコンテンツや悪質なユーザーを容認しません。"),
        ...
        case .privacy:
            return [
                LegalSection(title: "取得する情報", body: "ログインのためのメールアドレス、Firebase AuthのユーザーID、ユーザーが流したボトル本文、ボトルの色、通報・ブロック情報を扱います。"),
                ...
                LegalSection(title: "データ削除", body: "アカウント削除を行うと、ログイン情報とサーバー上の自分のボトルが削除されます。通報・ブロック対応や不正防止に必要な最小限の記録は一定期間残る場合があります。")
            ]
        }
    }
}
